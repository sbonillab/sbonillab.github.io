...
**Metodología:**
1. **Modelado espacial:** Se evalúa la distribución y expansión con variables topográficas, ocupación del suelo, imágenes multiespectrales, estudios de campo y ciencia ciudadana.
2. **Comunicación y educación:** Programa para líderes y responsables locales, aumentando concienciación y compromiso.
3. **Gestión experimental:** Monitoreo y erradicación en zonas sensibles (Conocoto y Nayón).
